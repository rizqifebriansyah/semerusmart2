            ...
            <table class="table table-sm text-md">
                ...
                <tbody>
                    <tr class="text-center">
                        ...
                        <td>
                            <textarea readonly disabled name="nama_perawat" class="form-control" id="nama_perawat" name="nama_perawat" cols="30" rows="2"><?php echo e(strtoupper(auth()->user()->name)); ?></textarea>
