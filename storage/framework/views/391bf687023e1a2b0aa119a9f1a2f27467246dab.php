        ...
        <div id="tabelpasien" class="container" >
            ...
            <table id="datapasien" class="table table-sm text-xs table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr class="pilihpasien toastsDefaultSuccess" nomor-rm="<?php echo e($p->no_rm); ?>" nama="<?php echo e($p->nama); ?>" kodekunjungan="<?php echo e($p->kode_kunjungan); ?>" alamat="<?php echo e($p->alamat); ?>" counter="<?php echo e($p->counter); ?>"umur="<?php echo e($p->umur); ?>" unit="<?php echo e($p->unit); ?>" tgl_masuk = "<?php echo e($p->tgl_masuk); ?>">
